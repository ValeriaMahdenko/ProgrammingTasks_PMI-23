...
class DepartmentTBL(Department, db.Model):
    ...
    def __init__(self, user_id, amount, title, director_name, phone_number, monthly_budget, yearly_budget, website_url):
        super().__init__(user_id, amount, title, director_name, phone_number, monthly_budget, yearly_budget, website_url)
